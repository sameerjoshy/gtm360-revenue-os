            ...
            <div className="max-w-7xl mx-auto h-[calc(100vh-200px)] flex gap-6">
                ...
                <div className="w-1/3 bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                    <div className="p-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                        ...
                        <span className="text-xs font-mono bg-orange-100 text-orange-700 px-2 py-0.5 rounded">{deals.length} Active</span>
                    </div>
                    <div className="overflow-y-auto flex-1 p-2 space-y-2">
                        {deals.map(deal => (
                            <div
                                ...
                                className={`p-4 rounded-lg cursor-pointer transition-all border ${selectedDealId === deal.id ? 'bg-orange-50 border-orange-200 shadow-sm' : 'bg-white border-slate-100 hover:border-orange-100 hover:bg-slate-50'}`}
                            >
                        ...
                        <>
                            ...
                            <div className="p-6 border-b border-slate-100 flex justify-between items-start">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className={`px-6 py-2 rounded-lg font-bold text-white shadow-md transition-all flex items-center gap-2 ${loading ? 'bg-slate-400 cursor-not-allowed' : 'bg-orange-600 hover:bg-orange-700 hover:shadow-lg'}`}
                                >
                                    {loading ? (
                                        <>
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-3 gap-4">
                                            ...
                                            <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                                                ...
                                                <div className="text-sm font-medium mt-1 text-orange-600 leading-snug">
